...
import CategoryType from "../components/ui/categoryTypes/CategoryType";
...
const bestExperiences = [
  ...
  console.log('categoryData___' , categoryData)
  // Show full-page loading until both API calls complete
  const isLoading = domainLoading || categoryLoading;
